...
SST_plot/C16_O_plot/C16_Mg_Ca_plot+plot_annotation(title = "C16", subtitle="Comparison of SST, d18O, and Mg/Ca from shell specimen C16")
...
C17_Mg_Ca_plot <-
  ...
  annotate("rect", xmin = 0, xmax = 5.6, ymin = 0.25, ymax = 0.6,
  alpha = .2)+
  annotate("text",x=1.3,y=0.65,label="extent of d18O record", alpha=.6)



SST_plot/C17_O_plot/C17_Mg_Ca_plot+plot_annotation(title = "C17", subtitle="Comparison of SST, d18O, and Mg/Ca from shell specimen C17")
